...
function startGame () {
  ...
  document.querySelector("#cheese1_container").classList.add("falling2", "pos2"); 
   ...
   startTimer ();
    ...
    document.querySelector("#carrot1_container").addEventListener("animationiteration", sqeezeCarrot);
...
function carrotHit() {
    ...
    //rotate carrotHit
    document.querySelector("#carrot1_sprite").classList.add("zoom_out");
    //1 point
    points = points + 1;
...
function sqeezeCarrot() {
    console.log(`sqeezeCarrot`);
    ...
    this.firstElementChild.removeEventListener("animationend", restartCarrot);
...
function restartCarrot() {
    ...
    this.classList.value = "";
    // removes the animationend eventlistener from the sprite
    this.removeEventListener("animationend", restartCarrot);
    // jumps a javascript frame 
...
function eggplantHit() {
    ...
    //rotate 
    document.querySelector("#eggplant1_sprite").classList.add("zoom_out");
    //1 point
    points = points + 1;
    console.log(`Points: ${points}`);
    document.querySelector("#current_score").textContent = points;
...
function chipsHit() {
    ...
    //rotate 
    document.querySelector("#chips1_sprite").classList.add("zoom_out");
    //1 point
    points = points + 1;
    console.log(`Points: ${points}`);
    document.querySelector("#current_score").textContent = points;
...
function breadHit() {
    ...
    //rotate 
    document.querySelector("#bread1_sprite").classList.add("zoom_out");
    //1 point
    points = points + 1;
    console.log(`Points: ${points}`);
    document.querySelector("#current_score").textContent = points;
